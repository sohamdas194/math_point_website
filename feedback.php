...
<body>
    <div class="page-wrapper">
        ...
        <div class="container-fluid" style="margin-top:-35px;">
            <div class="row">
                <img src="images/feedback.jpg" width="100%" class="img-responsive">
            </div>
        </div>
                        ...
                        <div class="col-md-12 tabs-content clearfix">
                            ...
                            <div class="tab active-tab" id="tab-one">
                                ...
                                <div class="cust-form">
                                    ...
                                    ?>
                                            <center>
                                                <div class="alert-success" style="font-size:24px"><?php echo "Thank you for your feedback !" ?></div>
                                            </center>
                                        <?php
                                        } else {
                                        ?>
                                    ...
                                    <form name="htmlform" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <input type="email" name="email" required maxlength="80" size="30" placeholder="Enter Email">
                                    
                                        <label class="required" for="phone">Phone Number</label>
                                        <input type="text" required maxlength="10" name="phone" required placeholder="Enter Phone no.">
                                    
                                        <label class="required" for="comments">Comments</label>
                                        <textarea name="comment" maxlength="1000" cols="30" rows="4" required placeholder="Enter Message"></textarea>
