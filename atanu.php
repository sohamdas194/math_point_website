        ...
        <div role="main" class="main">
            <div class="container" style="margin-top:20px;">
                <div class="row">
                        ...
                        <div data-plugin-options='{"items": 1, "margin": 10}'>
                            <div>
                                <span class="img-thumbnail">
                                    <img class="img-responsive" src="images/atanu.jpg">
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <h2 class="mb-none"> <strong>Mr. Atanu Ainch</strong></h2>
                        <hr class="solid">
                        <p style="color:#000;"></p>
                        <ul class="list list-icons">
                            <li><i class="fa fa-check"></i> Qualification: MSc (Mathematics)</li>
                            <li><i class="fa fa-check"></i> Experience: 14 Years</li>
                        </ul>
                    </div>
                </div>
