...
<body>
    <div class="page-wrapper">
        ...
        <div class="container-fluid" style="margin-top:-35px;">
            <div class="row">
                <img src="images/download.jpg" width="100%" class="img-responsive">
            </div>
        </div>
                    ...
                    <div class="tabs-box clearfix">
                        ...
                        <div class="col-md-12 tabs-content clearfix">
                            ...
                            <div class="tab active-tab" id="tab-one">
                                ...
                                <a href="books\SYLLABUS OF BCA 1ST YEAR.docx" target="_blank">
                                    <p><strong>1.Syllabus_BCA_by_MATH_POINT WORD FILE</strong></p>
                                </a>
                                <a href="books\Accounting book.pdf" target="_blank">
                                    <P><strong>2.Accounting books PDF</strong></P>
                                </a>
                                <a href="books\c programming book.pdf" target="_blank">
                                    <P><strong>3.Programming with C language PDF</strong></P>
                                </a>
                                <a href="books\c++ programming.pdf" target="_blank">
                                    <P><strong>4.Programming with C++ language PDF</strong></P>
                                </a>
                                <a href="books\computer_graphics book.pdf" target="_blank">
                                    <P><strong>5.Computer graphics PDF</strong></P>
                                </a>
                                <a href="books\data_communication_computer_network book.pdf" target="_blank">
                                    <P><strong>6.Data_communication_computer_network book PDF</strong></P>
                                </a>
                                <a href="books\data_structures_ book.pdf" target="_blank">
                                    <P><strong>7.Data_structures PDF</strong></P>
                                </a>
                                <a href="books\DBMS book.pdf" target="_blank">
                                    <P><strong>8.DBMS PDF</strong></P>
                                </a>
                                <a href="books\E_commerce book.pdf" target="_blank">
                                    <P><strong>9.E_commerce PDF</strong></P>
                                </a>
                                <a href="books\Fundamentals of digital electronics.pdf" target="_blank">
                                    <P><strong>10.Fundamentals of digital electronics PDF</strong></P>
                                </a>
                                <a href="books\Internet book.pdf" target="_blank">
                                    <P><strong>11.Internet PDF</strong></P>
                                </a>
                                <a href="books\java book.pdf" target="_blank">
                                    <P><strong>12.JAVA PDF</strong></P>
                                </a>
                                <a href="books\Microprocessorbook.pdf" target="_blank">
                                    <P><strong>13.Microprocessor PDF</strong></P>
                                </a>
                                <a href="books\Operating_system book.pdf" target="_blank">
                                    <P><strong>14.Operating_system PDF</strong></P>
                                </a>
                                <a href="books\TheoryOfComputation book.pdf" target="_blank">
                                    <P><strong>14.Theory Of Computation PDF</strong></P>
                                </a>
                            </div>
                        </div>
                    </div>
