...
if (isset($_POST['submit'])) 
{
	...
	$result=mysqli_query($conn,"SELECT * FROM `user` WHERE `email`='$uname' and `password`='$pwd'");
	...
	{
	    echo "<script>alert('Wrong Username Or Password !'); location.href='student.php';</script>";
	}
}
?>
...
<body>
    <div class="page-wrapper">
        ...
        <div class="container-fluid" style="margin-top:-35px;">
            <div class="row">
                <img src="images/student.jpg" width="100%" class="img-responsive">
            </div>
        </div>
