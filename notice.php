...
<body>
    <div class="page-wrapper">
        ...
        <div class="container-fluid" style="margin-top:-35px;">
            <div class="row">
                <img src="images/notice.jpg" width="100%" class="img-responsive">
            </div>
        </div>
                    ...
                    <div class="tabs-box clearfix">
                        ...
                        <div class="col-md-12 tabs-content clearfix">
                            ...
                            <div class="tab active-tab" id="tab-one">
                                ...
                                <a href="files\BCARESULT.pdf" target="_blank">
                                    <P><strong>1.Provisional Result of the B.C.A. (Hons.) UNDER BURDWAN UNIVERSITY PDF </strong></P>
                                </a>
                                <a href="files\BBARESULT.pdf" target="_blank">
                                    <P><strong>2.Provisional Result of the B.B.A. (Hons.) UNDER BURDWAN UNIVERSITY PDF </strong></P>
                                </a>
                                <a href="files\BT.pdf" target="_blank">
                                    <P><strong>3.Provisional Result of the B.Sc.(Hons.) in Biotechnology UNDER BURDWAN UNIVERSITY PDF </strong></P>
                                </a>
                                <a href="files\BC.pdf" target="_blank">
                                    <P><strong>4.Provisional Result of the B.Sc.(Hons.) in Biochemistry UNDER BURDWAN UNIVERSITY PDF </strong></P>
                                </a>
                        </div>
                    </div>
                </div>
