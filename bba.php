                        ...
                        <div data-plugin-options='{"items": 1, "margin": 10}'>
                            <div>
                                <span class="img-thumbnail">
                                    <img class="img-responsive" src="images/bbas.jpg">
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <h2 class="mb-none"> <strong>Bachelor of Business Administration</strong></h2>
                        <hr class="solid">
                        <p style="color:#000;">The Bachelor of Business Administration (BBA or B.B.A.) is a bachelor's
                            degree in commerce and business administration. The degree is conferred after four years of
                            full-time study in one or more areas of business concentrations.
                        </p>
                        <ul class="list list-icons">
                            <li>
                                <i class="fa fa-check"></i> BBA develops aspirant’s managerial abilities by providing a
                                broader perspective through information of every function. The program enhances the
                                candidate’s decision-making capability and communication skills.
                            </li>
                            <li>
                                <i class="fa fa-check"></i> BBA graduates can obtain straight entry into the corporate
                                world.
                            </li>
                        </ul>
                    </div>
