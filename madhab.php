                        ...
                        <div data-plugin-options='{"items": 1, "margin": 10}'>
                            <div>
                                <span class="img-thumbnail">
                                    <img class="img-responsive" src="images/madhab.jpg">
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <h2 class="mb-none"> <strong>Mr. Madhab Bandyopadhyay</strong></h2>
                        <hr class="solid">
                        <p style="color:#000;"></p>
                        <ul class="list list-icons">
                            <li><i class="fa fa-check"></i> Qualification: MCA (Master Of Computer Application)</li>
                            <li><i class="fa fa-check"></i> Experience: 11 Years</li>
                        </ul>
                    </div>
                </div>
                <div class="row">
