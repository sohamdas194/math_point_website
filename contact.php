...
<body>
    <div class="page-wrapper">
        ...
        <div class="container-fluid" style="margin-top:-35px;">
            <div class="row">
                <img src="images/contact.jpg" width="100%" class="img-responsive">
            </div>
        </div>
                        ...
                        <div class="col-md-12 tabs-content clearfix">
                            ...
                            <div class="tab active-tab" id="tab-one">
                                ...
                                <div class="cust-form">
                                    ...
                                    ?>
                                          <center>
                                             <div class="alert-success" style="font-size:24px"><?php echo "Thank you we will contact you soon" ?></div>
                                          </center>
                                       <?php
                                       } else {
                                       ?>
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <input id="name" name="name" type="text" value="" size="30" required placeholder="Enter Name">

                                        <label class="required" for="email">Your email:</label>
                                        <input id="email" name="email" type="text" value="" size="30" required placeholder="Enter Email">

                                        <label class="required" for="message">Your message:</label>
                                        <textarea name="message" maxlength="1000" cols="30" rows="4" required placeholder="Enter Message"></textarea>
