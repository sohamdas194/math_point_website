                        ...
                        <div data-plugin-options='{"items": 1, "margin": 10}'>
                            <div>
                                <span class="img-thumbnail">
                                    <img class="img-responsive" src="images/bcas.jpg">
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <h2 class="mb-none"> <strong>Bachelor of Computer Application</strong></h2>
                        <hr class="solid">
                        <p style="color:#000;">Bachelor of Computer Applications is a three year undergraduate degree
                            course in the field of computer applications.It's generally a regular degree course in most
                            universities. Some students use online or distance education programs to earn this degree.
                            It is a technical degree that prepares students for a career in the field of computer
                            applications and software development.
                        </p>

                        <ul class="list list-icons">
                            <li><i class="fa fa-check"></i>BCA Stands for the Bachelor in Computer Application.BCA is 3
                                year graduation degree course generally for those students who wants to learn Computer
                                languages and after that who wants to join Software companies.
                            </li>
                        </ul>
                    </div>
                </div>
